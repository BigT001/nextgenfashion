  ...
  if (status === "loading" || isLoading) {
    return (
      <div className="min-h-[80vh] flex flex-col items-center justify-center space-y-4">
        ...
        <p className="text-[10px] font-black uppercase tracking-[0.3em] text-muted-foreground animate-pulse">Authenticating Customer Identity...</p>
      </div>
    );
  }
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10">
            <div className="flex items-center gap-8">
              ...
              <div className="space-y-1">
                <h1 className="text-5xl font-black tracking-tighter leading-tight">{session?.user?.name || "Customer"}</h1>
              ...
              <div className="space-y-6">
                {orders.length === 0 ? (
                  <div className="glass-card p-20 text-center rounded-[3rem] border-none shadow-sm">
                    ...
                    <p className="text-xl font-bold text-foreground/50 italic mb-6">No orders recorded yet.</p>
                    ...
                    <div key={order.id} className="glass-card overflow-hidden rounded-[2.5rem] border-none shadow-sm group hover:shadow-2xl hover:shadow-brand-navy/5 transition-all duration-500">
                      <div className="p-8 md:p-10 flex flex-col md:flex-row items-center justify-between gap-8">
                        <div className="flex items-center gap-6">
                            ...
                            <div className="space-y-1">
                                <p className="text-[10px] font-black uppercase tracking-widest text-muted-foreground opacity-60">ORDER ID</p>
            ...
            <div className="lg:col-span-4 space-y-10 lg:sticky lg:top-32">
                <div className="glass-card p-10 rounded-[3rem] border-none shadow-2xl space-y-10 relative overflow-hidden">
                    ...
                    <div className="space-y-6 relative z-10">
                         <div className="flex items-center gap-4">
                            ...
                            <h3 className="font-black text-lg tracking-tight">Purchase Pulse</h3>
                        </div>
                ...
                <div className="bg-zinc-950 rounded-[3rem] p-10 text-white space-y-6 shadow-2xl shadow-zinc-950/30">
                    ...
                    <p className="text-xs text-zinc-400 font-medium leading-relaxed">
                        As a VIP Customer, you have direct access to our priority fulfillment lines. Every order is audited for quality before dispatch.
                    </p>
