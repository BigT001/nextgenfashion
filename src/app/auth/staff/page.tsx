...
import { Terminal, ShieldAlert, Lock, Mail, Activity, Cpu } from "lucide-react";
  ...
  async function onSubmit(values: StaffLoginValues) {
    ...
    try {
      ...
      if (result?.error) {
        ...
        console.log(`[STAFF_LOGIN] Success, redirecting to ${callbackUrl}`);
        // Use hard redirect to ensure session is picked up by middleware
